...
var Veterinaria = /** @class */ (function () {
    function Veterinaria(nombre, direccion, ID_Veterinaria) {
        this.nombre = nombre;
...
var Profesor = /** @class */ (function () {
    function Profesor(nombre, DNI, listaVeterinarias) {
        this.nombre = nombre;
        this.DNI = DNI;
    ...
    Profesor.prototype.mostrarAlumnos = function () {
        console.log(this.listaVeterinarias);
    };
    return Profesor;
}());
...
var ID;
var arrayProfe = [];
function crearVeterinaria(nombre, direccion, ID, arr) {
    ID = random(1, 5);
    var nuevaVeterinaria = new Veterinaria(nombre, direccion, ID);
